      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <h1>HERE TO GET YOU THERE.</h1>
            <p>We have countless cars for you to choose from. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Modern Spin has a huge collection of cars to choose from inorder to suit your needs. Need a vaction car? we got you. Need a car for family? We got you. Need a car to go out with friends? We got you. Modern Spin is here to get you there.</p>
    </div>
    <div class="row"> 
...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand WHERE tblbrands.BrandName='Dodge'";
